...
"Ingrese sus apellido: <input type='text' name='apellido' value='' size='30'/><br>"+
...
"Numero de Contribuyente: <input type='text' name='numcontribuyente' value='' size='45' /><br>"+
"Tipo Cliente<select name='tipo'>"+
...
"<input type='submit' value='Enviar' name='enviar' /><br>"+
              ...
              rs = s.executeQuery ("select * from cliente where idcliente='"+Id+"'");
                while(rs.next()){
                   out.println(
                                 "<form action='MantCliente' method='POST'>"+
    "<input type='text' name='codigo' value="+rs.getString("idcliente")+" hidden='hidden'/>"+
    "Ingrese sus nombres: <input type='text' name='nombre' value="+rs.getString("nombre_cliente")+" size='30' /><br>'"+
    "Ingrese sus apellido: <input type='text' name='apellido' value="+rs.getString("apellido_cliente")+" size='30'/><br>"+
    "Direccion: <input type='text' name='direccion' value="+rs.getString("direccion_cliente")+" size='30'/><br>"+
    "Telefono: <input type='text' name='telefono' value="+rs.getString("telefono_cliente")+" size='10' /><br>"+
    "Numero de Contribuyente: <input type='text' name='numcontribuyente' value="+rs.getString("numero_contribuyente_cliente")+" size='45' /><br>"+
    "Tipo Cliente<select name='tipo'>"+
    "<option value='1' >1</option>"+
    "<option value='2'>2</option>"+
    "</select>"+
    ...
    <tr><th>Nombre</th><th>Apellido</th><th>Direccion</th><th>Telefono</th><th>Numero Contribuyente</th><th>Tipo Cliente</th><th>Actualizar</th><th>Eliminar</th></tr>
        <%
            ...
            while (rs.next()){
            out.println("<tr><td>"+
rs.getString("nombre_cliente")+"</td><td>"+rs.getString("apellido_cliente")+"</td><td>"+rs.getString("direccion_cliente")+"</td><td>"+
